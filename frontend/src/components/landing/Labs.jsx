...
import lab1 from "../../assets/new-assets/img/lab1.jpg";
import lab2 from "../../assets/new-assets/img/lab2.jpg";
import lab3 from "../../assets/new-assets/img/lab3.jpg";
import lab4 from "../../assets/new-assets/img/lab4.jpg";
import lab5 from "../../assets/new-assets/img/lab5.jpg";
  ...
  return (
    <div className="min-h-screen flex flex-col justify-center lg:px-32 px-5 pt-16">
      <div className="flex flex-col items-center lg:flex-row justify-between mb-10 lg:mb-0">
        <div>
          <h1 className="text-4xl font-semibold text-center lg:text-start">Our Labs</h1>
