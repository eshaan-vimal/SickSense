...
def create_report(output_file, patient_data):
    ...
    """
    contact_info = """
    Phone: +91 1234567890 | Email:sicksense.app@gmail.com
    """
    ...
    ('BACKGROUND', (0, 0), (0, -1), colors.HexColor(lighter_colour)),
    ('BACKGROUND', (2, 0), (2, 2), colors.HexColor(lighter_colour)), 
    ...
    table.setStyle(TableStyle([
        ('BACKGROUND', (0, 0), (-1, 0), colors.HexColor(lighter_colour)),
        ('TEXTCOLOR', (0, 0), (-1, -1), colors.black),
        ('ALIGN', (0, 0), (-1, -1), 'LEFT'),
        ('FONTNAME', (0, 0), (-1, -1), 'Helvetica-Bold'),
        ('FONTSIZE', (0, 0), (-1, -1), 10),
    ...
    contact_info = "Phone: +91 1234567890 | Email: sicksense.app@gmail.com"
...
def add_graphs(elements, patient_data):
    ...
    values = [float(patient_data['disease_detection'][disease]['risk'][:-1]) for disease in patient_data['disease_detection']]
    ...
    ax.bar(diseases, values, color=light_colour, width=bar_width)
    ...
    ax.pie(pie_values, labels=pie_labels, colors=[lighter_colour, light_colour, dark_colour], autopct='%1.1f%%', startangle=140)
...
def add_genomic_risk_score(elements, patient_data):
    ...
    for disease in patient_data['drug_recommendation']:
        ...
        fig, ax = plt.subplots()
        ax.barh(markers, risks, color=light_colour)
...
def add_lifestyle_impact(elements, patient_data):
    ...
    ax.fill(angles, values, color=light_colour, alpha=0.25)
    ax.plot(angles, values, color=dark_colour, linewidth=2)
